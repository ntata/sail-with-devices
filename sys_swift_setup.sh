...
ln -s  ${SWIFT_MOUNT_BASE_DIR}/sda1/1 ${SWIFT_DISK_BASE_DIR}/1
ln -s  ${SWIFT_MOUNT_BASE_DIR}/sdb1/2 ${SWIFT_DISK_BASE_DIR}/2
ln -s  ${SWIFT_MOUNT_BASE_DIR}/sdc1/3 ${SWIFT_DISK_BASE_DIR}/3
ln -s  ${SWIFT_MOUNT_BASE_DIR}/sdd1/4 ${SWIFT_DISK_BASE_DIR}/4
